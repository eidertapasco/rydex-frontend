...
export class CatalogComponent implements OnInit {
  ...
  get tipoLabel(): string {
    if (this.tipo === 'all') return 'All Bikes Collection'; // <-- NUEVO
  ...
  loadBikes(): void {
    ...
    this.error.set(null);
    // CORRECCIÓN: Si el tipo es 'all', no enviamos el filtro 'tipo' al backend
    const f: BikeFilters = {
      ...
      tipo: (this.tipo && this.tipo !== 'all') ? this.tipo.toUpperCase() : undefined,
      ...this.filters()
    };
